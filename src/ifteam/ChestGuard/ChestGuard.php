...
class ChestGuard extends PluginBase implements Listener {
	...
	public $areaProvider = null;
	public $rentProvider = null;
	public function onEnable() {
		...
		if ($this->getServer ()->getPluginManager ()->getPlugin ( "SimpleArea" ) != null) {
			$this->areaProvider = \ifteam\SimpleArea\database\area\AreaProvider::getInstance ();
			$this->rentProvider = \ifteam\SimpleArea\database\rent\RentProvider::getInstance ();
		}
